...
from aerospace.entity.config_entity import DataValidationConfig
...
class DataValidation:
    def __init__(self,data_validation_config : DataValidationConfig,
        ...
        try:
            ...
            self.test_data = IngestedDataValidation(
                valiadte_path = self.data_ingestion_artifact.test_file_path,schema_path = self.schema_path
            )
    ...
    def initiate_data_validation(self):
        try:
            data_validation_artifact = DataValidationArtifact(
                schema_file_path=self.schema_path , is_valiadted=self.is_validation_successfull(),
    ...
    def __del__(self):
        logging.info(f"{'>>' * 20 } Data validation log complted {'<<' * 20}")
