...
from aerospace.config.configuration import *
    ...
    def get_data_validation_config(self)-> DataValidationConfig:
        try:
            ...
            schema_file_path = os.path.join(ROOT_DIR,
                                            ...
                                            daat_validation_config[DATA_VALIDATION_SCHEMA_FILE_NAME_KEY])
            ...
            raise CustomExceptio(e,sys) from e
    ...
    def get_training_pipeline_config(self)->TrainingPipelineConfig:
        try:
            ...
            artifact_dir=os.path.join(ROOT_DIR,
                                    training_pipeline_config[TRAINIG_PIPELINE_NAME_KEY],
